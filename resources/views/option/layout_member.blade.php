    ...
    <body>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="profile_edit" style="padding:15px; display:none;">
                    ...
                    <div id="logout_user_back" style="padding:15px; display:none;">
                        <span  onclick="logout_user_back();" style="cursor:pointer;">
        ...
        <script>
            function set_profile() {
                ...
                $('#logout_user').css('display','none');
                $('#logout_user_back').css('display','block');
            }

            function logout_user_back(){
                $('#profile_edit').css('display','none');
                $('#logout_user').css('display','block');
                $('#logout_user_back').css('display','none');
            }
        </script>
        <!-- jquery -->
