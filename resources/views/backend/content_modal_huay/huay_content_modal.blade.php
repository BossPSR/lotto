                    ...
                    <table class="table data-list-view">
                        ...
                        <tbody>
                            ...
                            if ($content_modals) {
                                $i = 0;
                                $index = -1;
                                foreach ($content_modals as $content_modal) {
                                    $i++;
                                    $index++;
                            ?>
                                    <tr>
                                        ...
                                        <td class="product-name">
                                            ...
                                            <a target="_blank" href="{{url($content_modal->image)}}"><img src="{{url($content_modal->image)}}" class="image_rules"></a>
                                            @endif
                                        ...
                                        <td class="text-center">
                                            <span data-toggle="modal" data-target="#edit" data-edit-id="{{$content_modal->id}}"><i class="fa fa-edit" style="font-size: 25px;"></i></span>
                                        </td>
                                    </tr>
                            <?php
                                }
                                ...
                                <div class="modal-dialog modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="/admin/content_modal_huay" onsubmit="doSubmit(this)" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group  mb-0">
                                                    <div class="text-right">
                                                        <button type="submit" class="btn btn-primary" name="addcontent_modals">เพิ่มข้อมูล</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                            ...
                                            <form method="POST" action="/admin/content_modal_huay" onsubmit="doSubmit(this)" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group  mb-0">
                                                    <div class="text-right" style="display: flex;flex-direction: row-reverse;">
                                                        <button type="submit" class="btn btn-primary" name="editcontent_modals">บันทึกข้อมูล</button>
                                                        <button class="btn btn-danger" name="deletecontent_modals">ลบ</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
    ...
    $(document).ready(function() {
        ...
        $('#edit').on('show.bs.modal', function(event) {
            ...
            $.ajax({
                    ...
                    data: {
                        _token: csrf_token,
                        'target_secret': '{{md5("get-content_modals")}}',
                        'get-id': id
                    },
                    dataType: 'JSON',
