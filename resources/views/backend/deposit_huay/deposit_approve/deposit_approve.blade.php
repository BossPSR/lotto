        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">อนุมัติแจ้งฝาก</h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">จัดการฝากเงิน</a>
                                </li>

                                <li class="breadcrumb-item active">อนุมัติแจ้งฝาก
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span data-toggle="modal" data-target="#condition" data-edit-id="{{$deposit_list->id}}" data-customer-name="{{$deposit_list->user_info->first_name}} {{$deposit_list->user_info->last_name}}" data-username="{{$deposit_list->user_info->username}}" data-created-at="{{date('d/m/Y H:i:s', strtotime($deposit_list->created_at))}}"><i class="fa fa-search" style="font-size: 25px;"></i></span>
                                        </td>
                                    </tr>
                            <?php
                                }
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel1">อนุมัติแจ้งฝาก</h4>
                ...
                <form method="POST" action="/admin/deposit_approve" onsubmit="doSubmit(this)">
                    ...
                    <div class="form-group  mb-0">
                        <div class="text-center" >
                            <button type="submit" class="btn btn-success" name="depositConfirm">อนุมัติ</button>
                            <button class="btn btn-danger" name="depositReject">ปฏิเสธ</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('#condition').on('show.bs.modal', function(event) {
            ...
            $.ajax({
                    ...
                    data: {
                        _token: csrf_token,
                        'target_secret': '{{md5("get-deposits")}}',
                        'get-id': id
                    },
                    dataType: 'JSON',
