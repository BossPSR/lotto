        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">ระบบจัดการผู้เล่น</h2>
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">ระบบจัดการผู้เล่น</a>
                                </li>

                                <li class="breadcrumb-item active">รายการผู้เล่น
                                </li>
                            </ol>
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel1">รายการผู้เล่น</h4>
            ...
            <div class="modal-body">
                <form method="POST" action="/admin/approve_user" onsubmit="doSubmit(this)" enctype="multipart/form-data">
                    ...
                    <input name="page" value="list_user" type="hidden">
                    ...
                    <div class="form-group  mb-0">
                        <div class="text-center">
                            <button type="submit" class="btn btn-warning" name="userBan">แบนสมาชิก</button>
                            <button class="btn btn-dark" name="userBlacklist">เพิ่มในบัญชีดำ</button>
                        </div>
                    </div>
                </form>
            </div>
