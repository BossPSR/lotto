    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel1">บัญชีดำ</h4>
            ...
            <div class="modal-body">
                <form method="POST" action="/admin/approve_user" onsubmit="doSubmit(this)" enctype="multipart/form-data">
                    ...
                    <input name="page" value="blacklist_user" type="hidden">
                    ...
                    <div class="form-group  mb-0">
                        <div class="text-center">
                            <button type="submit" class="btn btn-success" name="userConfirm">อนุมัติอีกครั้ง</button>
